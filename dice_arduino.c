/*
this is a super cool project which i created from the super great blog of Thomas Angielsky  
checkout his vlog on
https://create.arduino.cc/projecthub/tangielsky/shaking-arduino-dice-39fc6a?ref=tag&ref_id=fun&offset=5
*/
